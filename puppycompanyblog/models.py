...
class User(db.Model, UserMixin):
    ...
    profile = db.Column(db.String(64), nullable=False, 'default_profile.png')
    ...
    def __init__(self,email,username,password):     # WIth this we can make an instance to the user ("Like a constructor of JAva")
        self.email = email
